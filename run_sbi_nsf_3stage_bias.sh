...
python -m den_pie density-train params/sbi_nsf_train_stage1_encoder_bias.yaml --verbose

# Stage 2: Train flow with frozen encoder
python -m den_pie density-train params/sbi_nsf_train_stage2_flow_bias.yaml --verbose

# Stage 3: Fine-tune encoder + flow end-to-end
python -m den_pie density-train params/sbi_nsf_train_stage3_finetune_bias.yaml --verbose

# Evaluate and plot
python -m den_pie density-plot params/sbi_nsf_plot_3stage_bias.yaml --verbose
