...
# python -m den_pie density-train params/density_train.yaml --verbose

python -m den_pie density-train params/density_stage1_encoder.yaml
# update stage2 encoder model_location
python -m den_pie density-train params/density_stage2_flow.yaml
# update stage3 model_locations
python -m den_pie density-train params/density_stage3_finetune.yaml

python -m den_pie density-plot params/density_plot.yaml --verbose