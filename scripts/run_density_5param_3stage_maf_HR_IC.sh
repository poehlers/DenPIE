...
python -m den_pie density-train params/density_5param_train_stage1_encoder_maf_HR_ic.yaml --verbose

python -m den_pie density-train params/density_5param_train_stage2_flow_maf_HR_ic.yaml --verbose

python -m den_pie density-train params/density_5param_train_stage3_finetune_maf_HR_ic.yaml --verbose

python -m den_pie density-plot params/density_5param_plot_3stage_maf_HR_ic.yaml --verbose
