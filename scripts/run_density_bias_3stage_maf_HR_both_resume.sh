...
# Stage 1 (encoder) is already done — skipped on resume.
# best.pth: output/density_bias_Om_s8_b1_b2_bs2_bn2_HR_stage1_encoder_maf_both_latest/models/encoder/best.pth

python -m den_pie density-train params/density_bias_train_stage2_flow_maf_HR_both_resume.yaml --verbose

python -m den_pie density-train params/density_bias_train_stage3_finetune_maf_HR_both.yaml --verbose

python -m den_pie density-plot params/density_bias_plot_3stage_maf_HR_both.yaml --verbose
