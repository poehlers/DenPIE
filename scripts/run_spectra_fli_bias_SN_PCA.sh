...
python -m den_pie spectra-train params/spectra_train_fli_bias_SN_PCA.yaml --verbose
python -m den_pie spectra-plot  params/spectra_train_fli_bias_SN_PCA.yaml --verbose
