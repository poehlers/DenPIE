...
python -m den_pie density-train params/density_bias_train_stage1_encoder_nsf.yaml --verbose

python -m den_pie density-train params/density_bias_train_stage2_flow_nsf.yaml --verbose

python -m den_pie density-train params/density_bias_train_stage3_finetune_nsf.yaml --verbose

python -m den_pie density-plot params/density_bias_plot_3stage_nsf.yaml --verbose
