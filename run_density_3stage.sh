...
python -m den_pie density-train params/density_train_stage1_encoder.yaml --verbose

python -m den_pie density-train params/density_train_stage2_flow.yaml --verbose

python -m den_pie density-train params/density_train_stage3_finetune.yaml --verbose

python -m den_pie density-plot params/density_plot_3stage.yaml --verbose
