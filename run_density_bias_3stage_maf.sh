...
python -m den_pie density-train params/density_bias_train_stage1_encoder_maf.yaml --verbose

python -m den_pie density-train params/density_bias_train_stage2_flow_maf.yaml --verbose

python -m den_pie density-train params/density_bias_train_stage3_finetune_maf.yaml --verbose

python -m den_pie density-plot params/density_bias_plot_3stage_maf.yaml --verbose
