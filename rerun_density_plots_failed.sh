#!/bin/bash
#SBATCH --job-name=density_replot_fix
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
YAMLS=(
    # params/density_plot.yaml                # base_test (FrEIA, 1-stage) — fixed paths
    params/density_plot_multi_stage.yaml    # stage3_finetune (FrEIA, 3-stage) — fixed paths
)
